...
public class ResultsWriter {
	...
	public static void writeResults(IPatternSampler patternComputer, boolean writeFoundPatterns) {
	...
	private static void writeResultAsJSon(IPatternSampler patternComputer, BufferedWriter resultFile)
			throws IOException {
		resultFile.write("{\n");
